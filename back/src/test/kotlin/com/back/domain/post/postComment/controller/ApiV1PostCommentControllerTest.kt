...
class ApiV1PostCommentControllerTest {
    ...
    fun t2() {
        ...
        for (i in comments.indices) {
            ...
            resultActions
                ...
                .andExpect(jsonPath("$[$i].createDate").value(Matchers.startsWith(postComment.createDate.toString().take(20))))
                .andExpect(jsonPath("$[$i].modifyDate").value(Matchers.startsWith(postComment.modifyDate.toString().take(20))))
    ...
    fun t5() {
        ...
        resultActions
            ...
            .andExpect(jsonPath("$.data.createDate").value(Matchers.startsWith(postComment.createDate.toString().take(20))))
            .andExpect(jsonPath("$.data.modifyDate").value(Matchers.startsWith(postComment.modifyDate.toString().take(20))))
